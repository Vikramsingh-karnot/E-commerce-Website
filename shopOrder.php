...
<div class="container" style="color: #fff;font-family: 'Changa', sans-serif;">
		<div class="row justify-content-center">
    <div class="col-md-10 mb-5" style="text-align: center;">
      <h1><?= $itemName; ?></h1>
    </div>
			<div class="col-md-12 mb-5">
                <a href="<?= $itemImage; ?>" style="height: 200%;width: 200%"><img src="<?= $itemImage; ?>"  style="object-fit: cover;border-radius: 10px;width: 450px; height:450px;margin-left: 300px;margin-right: auto;"></a>
            </div>
