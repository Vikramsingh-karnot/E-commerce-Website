...
<nav class="navbar navbar-expand-md" style="background-color: black;">
  ...
  <div style="width: 50px; height: 50px;">
		<a href="#">
			<img src="images\16579655411555590644.svg" alt="" style="pointer: cursor;">
		</a>
	</div>
</nav> 

<div class="card_display" style="padding-bottom: 0px;">
	<div class="container">
		<div class="row">
			<?php  
				...
				{
			?>
					<div class="col-md-4 mt-3 mb-5" style = "padding-bottom:30px;">
						<div class="card-deck">
							<div class="card" style="width:400px;height: 630px;color: #d7d7d7;">
							  <img class="card-img-top" src="<?= $row['item_image']; ?>" style="height: 330px;width: 320px;margin: 15px auto 5px auto" />
							  <div class="card-body">
							    <h5 class="card-title" style="color:black;font-weight: bolder;margin-top: 20px;font-family: 'Changa', sans-serif;">Product : <?= $row['item_name']; ?></h5>
							    <h3 class="card-title" style="color: red;font-family: 'Grenze Gotisch', cursive;">Price : <?= number_format($row['item_price']); ?>/-</h3>
							    <a href="#" class="btn btn-block btn-lg" style="background-color: #212529;color: white;font-size: 20px;font-family: 'Changa', sans-serif;">Add to cart</a>
								<a href="shopOrder.php?id=<?= $row['id']; ?>" class="btn btn-block btn-lg" style="background-color: #212529;color: white;font-size: 20px;font-family: 'Changa', sans-serif;">
									Buy now</a>
							  </div>
							</div>
						</div>
